...
const slides = [
  {
    ...
    headline1: "LA VALL DE LES BRUIXES",
    headline2: "ADIESTRAMIENTO CANINO · GIRONA",
    body: "Educación canina con métodos positivos y respetuosos en el Baix Empordà, Girona. Ayudamos a entender y mejorar la conducta de tu perro en un entorno natural único, adaptado a todos los niveles.",
  },
  {
  ...
  },
  {
    ...
    headline1: "4.9 ESTRELLAS",
    headline2: "EN GOOGLE · BAIX EMPORDÀ",
    body: "Nuestros clientes nos avalan con una valoración excepcional. Sesiones guiadas por profesionales del adiestramiento para que tú y tu perro disfrutéis juntos en plena naturaleza.",
  },
];
