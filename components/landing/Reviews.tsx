...
const reviews = [
  {
    name: "Montse V.",
    initials: "MV",
    text: "Increíble el cambio que ha experimentado nuestro perro. El entorno natural donde trabajan es único y los métodos son muy respetuosos. Notamos mejoría desde la primera sesión.",
    rating: 5,
  },
  {
    name: "Tomàs B.",
    initials: "TB",
    text: "El mejor adiestrador de la zona con diferencia. Nuestro perro era muy nervioso y ahora está mucho más tranquilo y obediente. Todo con refuerzo positivo, sin castigos ni gritos.",
    rating: 5,
  },
  {
    name: "Elena C.",
    initials: "EC",
    text: "Muy contentos con los resultados. Profesionalidad, dedicación y mucho amor por los animales. Las sesiones son en un entorno precioso y nuestro perro las disfruta al máximo.",
    rating: 5,
  },
];
    ...
    <section className="py-16 lg:py-24 bg-[#2b2b2b]">
      <div className="container">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-12">
          ...
          <a
            href="https://www.google.com/maps/search/La+Vall+de+les+Bruixes+Girona"
            target="_blank"
